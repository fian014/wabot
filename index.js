...
const config = {
    A187: '☕Fian014☕', // TOBAT SU ASU
    instagram: 'https://instagram.com/fian_014', // INFO JANGAN DI UBAH
    nomer: 'wa.me/6285704617188', // INFO SU JNGAN DI UBAH
    youtube: 'https://m.youtube.com/channel/UCoRe-nP3qQZsN6QCniov5bw', // KINTIL
    whatsapp: 'https://chat.whatsapp.com/EhsOrRyaGAysAkUGkPnYaGRub', // BABI
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6285704617188@s.whatsapp.net"] // ganti nomer lu
			...
			switch(command) {
				...
				case 'menu':
					...
					teks = `➽𝐍𝐚𝐦𝐚 𝐛𝐨𝐭 : ${me.name}\n➽𝐍𝐨𝐦𝐞𝐫 𝐛𝐨𝐭 : @${me.jid.split('@')[0]}\n➽𝐏𝐫𝐞𝐟𝐢𝐱 : ${prefix}\n➽𝐓𝐨𝐭𝐚𝐥 𝐛𝐥𝐨𝐜𝐤 : ${blocked.length}\n➽𝐀𝐤𝐭𝐢𝐟 𝐬𝐞𝐣𝐚𝐤 : ${kyun(uptime)}\n➽𝐈𝐧𝐬𝐭𝐚𝐠𝐫𝐚𝐦 : https://www.instagram.com/fian_014\n➽𝐘𝐨𝐮𝐓𝐮𝐛𝐞 : https://m.youtube.com/channel/UCoRe-nP3qQZsN6QCniov5bw\n 𝐓𝐡𝐚𝐧𝐤𝐬 𝐭𝐨:\n➽𝐀𝐥𝐥𝐚𝐡 𝐒𝐖𝐓\n`
				...
				case 'logowolf':
					...
					if (args.length < 1) return reply(`teksnya mana? contoh ${prefix}logowolf Fian|Ganss`)
					reply(mess.wait)
           ...
           case 'demote':
              ...
              case 'abgjago':
				...
				case 'tts':
					...
					rano = getRandom('.ogg')
					dtt.length > 300
					? reply('𝗜𝗱𝗶𝗵 𝗻𝗴𝗲𝗹𝘂𝗻𝗷𝗮𝗸 𝗻𝗴𝗲𝗻𝘁*𝗱, 𝘁𝗲𝗸𝘀𝗻𝘆𝗮 𝗷𝗮𝗻𝗴𝗮𝗻 𝗸𝗲𝗽𝗮𝗻𝗷𝗮𝗻𝗴𝗮𝗻 😤')
				...
				case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `❮ 𝐏𝐚𝐭𝐫𝐢𝐜𝐤 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 ❯\n\n${body.slice(4)}`})
						}
						reply('𝐬𝐮𝐜𝐜𝐬𝐬 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `❮ 𝐏𝐚𝐭𝐫𝐢𝐜𝐤 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭 ❯\n\n${body.slice(4)}`)
						}
						reply('𝐬𝐮𝐜𝐜𝐬𝐬 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭')
					}
					break
